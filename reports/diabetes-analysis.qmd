...
diabetes_df = pd.read_csv("../results/tables/data_summary.txt",sep='\t')
diabetes_df
```
...
![Distribution of target variable, C_peptide](../results/tables/c_peptide_distribution.png){#fig-dist}

\![Scatterplot matrix of all variables](../results/scatterplot_matrix.png){#fig-scatter}
